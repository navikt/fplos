...
public class AvdelingslederSakslisteRestTjeneste {
    ...
    public void lagreSorteringTidsintervallValg(@NotNull @Parameter(description = "id til sakslisten") @Valid SakslisteOgAvdelingDto sakslisteOgAvdelingDto) {
        ...
        if (sakslisteOgAvdelingDto.getPeriodeFilterType() == null) {
            //TODO slett etter frontend er over på periodefilter
            ...
            oppgaveFiltrering.ifPresentOrElse(of -> avdelingslederTjeneste.settSorteringTidsintervallValg(sakslisteId, sakslisteOgAvdelingDto.getPeriodeFilterType()), () -> {
                    throw new IllegalArgumentException("Fant ikke listen");
            });
        }
