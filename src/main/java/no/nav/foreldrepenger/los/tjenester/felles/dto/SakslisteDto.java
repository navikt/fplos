...
public record SakslisteDto(@NotNull Long sakslisteId,
    ...
    public SakslisteDto(OppgaveFiltrering of, List<Saksbehandler> saksbehandlere, AktiveOgTilgjenglige aktiveOgTilgjenglige) {
        ...
        this(of.getId(), of.getNavn(), new SorteringDto(of), of.getBehandlingTyper(), of.getFagsakYtelseTyper(),
            ...
            KøSorteringFeltDto.alle(), saksbehandlerIdenter(saksbehandlere), statistikk);
    }
