...
public final class ReservasjonKonstanter {
    ...
    public static final String RESERVASJON_AVSLUTTET_SAKSBEHANDLER = "Opphevet av saksbehandler";
    ...
    public static boolean tekstBlantReservasjonKonstanter(String kandidat) {
        final var aktuelle = List.of(OPPGAVE_AVSLUTTET, RESERVASJON_AVSLUTTET_AVDELINGSLEDER, NY_ENHET, SLETTET_AV_ADMIN,
            RESERVASJON_VIDEREFØRT_NY_OPPGAVE, RESERVASJON_AVSLUTTET_SAKSBEHANDLER);
