...
class KøStatistikkTjenesteTest {
    ...
    void skalFinneStatistikkPåKøerSomMatcherOppgave() {
        ...
        Assertions.assertThat(stats.get(0).behandlingType()).isEqualTo(oppgave.getBehandlingType());
        Assertions.assertThat(stats.get(0).antallNye()).isZero();
        Assertions.assertThat(stats.get(0).antallFerdigstilte()).isEqualTo(1L);
    }
