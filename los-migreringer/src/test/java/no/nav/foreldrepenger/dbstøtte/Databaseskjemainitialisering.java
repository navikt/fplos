...
public final class Databaseskjemainitialisering {
    ...
    private static String getScriptLocation(String dsName) {
        ...
        return fileScriptLocation("los-migreringer/src/main/resources/db/migration/" + dsName);
    }
    ...
    private static String dbaScriptLocation() {
        ...
        return fileScriptLocation("los-migreringer/src/test/resources/db/migration/vl_dba");
    }
