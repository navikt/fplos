...
public final class Databaseskjemainitialisering {
    ...
    static {
        migrer(new DBProperties(DBA_DS_NAME, DBA_SCHEMA, dbaScriptLocation()));
    }
    ...
    public static void settJdniOppslag() {
        settJdniOppslag(DEFAULT_PROPERTIES);
    }

    public static void settJdniOppslagForUnitTests() {
        settJdniOppslag(JUNIT_PROPERTIES);
    }

    private static void settJdniOppslag(DBProperties properties) {
        try {
