...
import static no.nav.foreldrepenger.dbstoette.Databaseskjemainitialisering.dbProperties;
...
public class SjekkDbStrukturTest {
    ...
    public void sjekk_at_alle_tabeller_er_dokumentert() throws Exception {
        String sql = "SELECT table_name FROM all_tab_comments WHERE (comments IS NULL OR comments in ('', 'MISSING COLUMN COMMENT')) "
