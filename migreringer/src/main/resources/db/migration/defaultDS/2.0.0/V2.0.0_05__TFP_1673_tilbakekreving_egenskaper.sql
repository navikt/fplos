...
COMMENT ON COLUMN "TILBAKEKREVING_EGENSKAPER"."ID" IS 'PK';
...
CREATE UNIQUE INDEX "PK_TILBAKEKREVING_EGENSKAPER" ON "TILBAKEKREVING_EGENSKAPER" ("ID")
;

ALTER TABLE "TILBAKEKREVING_EGENSKAPER" MODIFY ("ID" NOT NULL ENABLE);
ALTER TABLE "TILBAKEKREVING_EGENSKAPER" MODIFY ("OPPGAVE_ID" NOT NULL ENABLE);
ALTER TABLE "TILBAKEKREVING_EGENSKAPER" ADD CONSTRAINT "PK_TILBAKEKREVING_EGENSKAPER" PRIMARY KEY ("ID")
    USING INDEX  ENABLE;

CREATE INDEX "IDX_TILBAKEKREVING_EGENSKAPER" ON "TILBAKEKREVING_EGENSKAPER" ("OPPGAVE_ID")
;
