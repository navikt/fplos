...
public class AdminRepositoryImpl implements AdminRepository {
    ...
    public List<EventmottakFeillogg> hentAlleMeldingerFraFeillogg() {
        return getEntityManager().createQuery("Select ef FROM eventmottakFeillogg ef where ef.Status = :status", EventmottakFeillogg.class).setParameter("status", EventmottakFeillogg.Status.FEILET.name()).getResultList();
    }
