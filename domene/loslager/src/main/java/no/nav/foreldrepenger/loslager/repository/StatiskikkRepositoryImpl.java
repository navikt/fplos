...
public class StatiskikkRepositoryImpl implements StatistikkRepository {
    ...
    public List<Object[]> hentAlleOppgaverForAvdeling(String avdelingEnhet) {
        return getEntityManager().createNativeQuery(
                ...
                .setParameter("tilBeslutter", AndreKriterierType.TIL_BESLUTTER.getKode()).getResultList();
    }
    ...
    public List hentAlleOppgaverForAvdelingPerDato(String avdelingEnhet) {
        return getEntityManager().createNativeQuery(
                ...
                .setParameter("avdelingEnhet", avdelingEnhet).getResultList();
    }
    ...
    public List hentNyeOgFerdigstilteOppgaver(Long sakslisteId) {
        ...
        for(AndreKriterierType andreKriterierType : oppgavespørringDto.getEkskluderAndreKriterierTyper()) {
            filtrerEkskluderAndreKriterier.append("NOT EXISTS (select 1 from OPPGAVE_EGENSKAP oen WHERE o.ID = oen.OPPGAVE_ID AND oen.aktiv = 'J' AND oen.ANDRE_KRITERIER_TYPE = '" + andreKriterierType.getKode() + "' ) AND ");
        }
        ...
        Query query = getEntityManager().createNativeQuery("SELECT o.BEHANDLING_TYPE, 0 AS ANTALL_NYE, count (*) as ANTALL_FERDIGSTILTE , COALESCE (trunc(o.ENDRET_TID), trunc(o.OPPRETTET_TID)) AS dato " +
               "FROM OPPGAVE o " +
               ...
               .setParameter("avdelingEnhet", oppgaveFiltrering.getAvdeling().getAvdelingEnhet());
    ...
    public List hentOppgaverPerFørsteStønadsdag(String avdeling) {
        return getEntityManager().createNativeQuery(
                ...
                .setParameter("avdelingEnhet", avdeling).getResultList();
    }
}
