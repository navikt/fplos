...
describe('<Label>', () => {
  ...
  it('skal ikke formatere input hvis den er en node', () => {
    const wrapper = shallow(<Label.WrappedComponent input="Hei" intl={intl as IntlShape} />);
  ...
  it('skal formatere input hvis den er en meldingsdefinisjon', () => {
    const wrapper = shallow(<Label.WrappedComponent input={{ id: 'Hei' }} intl={intl as IntlShape} />);
  ...
  it('skal rendre null hvis input er tom', () => {
    const wrapper = shallow(<Label.WrappedComponent intl={intl as IntlShape} />);
