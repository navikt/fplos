...
public class ArbeidsfordelingWebServiceHealthCheckTest {
    ...
    public void test_alt() {
        ...
        ArbeidsfordelingWebServiceHealthCheck check = new ArbeidsfordelingWebServiceHealthCheck(mockSelftestConsumer);
        ...
        new ArbeidsfordelingWebServiceHealthCheck(); // som trengs av CDI
    }
}
