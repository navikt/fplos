...
public interface KodeverkRepository {
    ...
    /**
     * Finn instans av SecondaryKodeliste innslag for angitt kode verdi.
     */
    <V extends Kodeliste> V finn(Class<V> cls, String kode);

    /**
     * Finn instans av SecondaryKodeliste innslag for angitt SecondaryKodeliste.
     * For oppslag av fulle instanser fra de ufullstendige i hver konkrete subklasse av SecondaryKodeliste.
     */
    <V extends Kodeliste> V finn(Class<V> cls, V kodelisteKonstant);

    /**
     * Finn instans av SecondaryKodeliste innslag for angitt offisiell kode verdi.
     */
    <V extends Kodeliste> V finnForKodeverkEiersKode(Class<V> cls, String offisiellKode);

    /**
     * Finn instans av SecondaryKodeliste innslag for angitt offisiell kode verdi, eller en default value hvis offisiell kode ikke git treff.
     */
    ...
    /**
     * Hent alle innslag for en gitt SecondaryKodeliste.
     */
